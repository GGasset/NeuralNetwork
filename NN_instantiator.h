...
class NN_instantiator
{
	...
	static NN* Instantiate(size_t* shape, NN::NeuronTypeIdentifier* layer_types, size_t layer_count, ActivationFunctions::ActivationFunction* layer_activations, int8_t weight_direction_from_0 = 0, size_t max_neuron_count = 0, bool free_layer_types = true, bool free_layer_activations = true)
	{
		...
		return Instantiate(shape, layer_types, layer_count, layer_activations, layer_weight_direction, max_neuron_count, free_layer_types, free_layer_activations);
	}
	...
	/// <param name="layer_count">| Input layer is included in the length</param>
	/// <param name="layer_activations">| There are some neurons like DenseLSTM that don't need this, use None for example</param>
	static NN* Instantiate(size_t* shape, NN::NeuronTypeIdentifier* layer_types, size_t layer_count, ActivationFunctions::ActivationFunction* layer_activations, int8_t* layer_weight_direction_from_0, size_t max_neuron_count = 0, bool free_layer_types = true, bool free_layer_activations = true)
	{
